...
export function InstallationSection() {
  ...
  const getCommand = () => {
    switch (packageManager) {
      case "pnpm":
        return "pnpm dlx reloop-cli add hello-world";
      case "npm":
        return "npx reloop-cli add hello-world";
      case "yarn":
        return "yarn dlx reloop-cli add hello-world";
      case "bun":
      default:
        return "bunx --bun reloop-cli add hello-world";
    }
  };
  ...
  return (
    <div id="installation" className="space-y-4 pt-6">
